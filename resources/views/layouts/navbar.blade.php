<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="/dashboard" style="color: white">
            <i class="fa fa-fw" aria-hidden="true" title="Copy to use leaf" style="color: greenyellow">&#xf06c</i>
            Rekapitulasi sawit</a>
    </div>
    ...
    <ul class="nav navbar-right navbar-top-links">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li>
                    <a href="/setting/users"><i class="fa fa-gear fa-fw"></i> Settings</a>
                </li>
                <li class="divider"></li>
                <li>
