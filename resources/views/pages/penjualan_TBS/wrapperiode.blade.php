...
@section('container')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Penjualan {{ $menu }} tiap periode</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div>
                            <form method="GET" id="perPageForm" class="container-filter-datatables">
                                ...
                                <div class="container-right-datatables">
                                    ...
                                    <div class="form-filter-datatables">
                                        <a href="{{ '/penjualan/tbs/' . request('menu') . '/periode' }}"
                                        ...
                                        @foreach ($items as $item)
                                            <tr class="">
                                                ...
                                                <td style="display: flex; border-bottom: 1px">
                                                    <a href="/penjualan/tbs/{{ $menu }}/{{ $item->id }}/view"
                                                        class="btn btn-primary  btn-edit">
                                                        <i class="fa fa-fw" aria-hidden="true"
                                                            title="Copy to use truck">&#xf0d1</i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
