...
@section('container')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Pekerjaan nonsawit tiap periode</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div>
                            <form method="GET" id="perPageForm" class="container-filter-datatables">
                                ...
                                <div class="container-right-datatables">
                                    ...
                                    <div class="form-filter-datatables">
                                        <a href="{{ '/pekerjaan-nonsawit/periode' }}" class="btn btn-info btn-sm">
                                    ...
                                    <tbody>
                                        @foreach ($items as $item)
                                            <tr class="">
                                                ...
                                                <td>{{ number_format($item->total_netto, 0, ',', '.') }}</td>

                                                <td class="center">{{ $item->formatted_created_at }}</td>
                                                <td style="display: flex; border-bottom: 1px">
                                                    <a href="/pekerjaan-nonsawit/{{ $item->id }}/view"
                                                        class="btn btn-primary  btn-edit">
                                                        <i class="fa fa-fw" aria-hidden="true"
                                                            title="Copy to use briefcase">&#xf0b1</i>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
